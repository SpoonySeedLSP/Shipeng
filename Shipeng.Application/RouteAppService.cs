...
namespace Shipeng.Application
{
    ...
    public class RouteAppService: BaseApplicationService,IRouteAppService
    {
        ...
        /// <returns></returns>
        public async Task<ShipengResult> CreateAsync(CreateRouteDto createRouteDto)
        {
        ...
        /// <param name="routeId">路由ID</param>
        /// <returns></returns>
        public async Task<ShipengResult<RouteDto>> GetAsync(Guid routeId)
        {
        ...
        /// <returns></returns>
        public async Task<ShipengResult> UpdateAsync(UpdateRouteDto updateRouteDto)
        {
            //更新路由信息
        ...
        /// <returns></returns>
        public async Task<ShipengResult> UpdateStateAsync(Guid routeId, bool useState)
        {
        ...
        public async Task<ShipengResult<List<RouteMainDto>>> GetListAsync()
        {
