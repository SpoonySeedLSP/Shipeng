...
namespace Shipeng.Application
{
    ...
    public class WhitelistAppService: BaseApplicationService, IWhitelistAppService
    {
        ...
        public async Task<ShipengPageResult<List<WhitelistDto>>> GetListAsync(string kw = "", int page = 1, int pageSize = 10)
        {
        ...
        public async Task<ShipengResult> CreateAsync(CreateWhitelistDto createWhiteList)
        {
        ...
        public async Task<ShipengResult<WhitelistDto>> GetAsync(Guid id)
        {
