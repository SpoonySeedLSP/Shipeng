...
namespace Shipeng.Util
{
    public static partial class ExtLinq
    {
        ...
        {
            return InvokeSortBy(query, sortPredicate, QuerySortOrder.Ascending);
        }
        ...
        public static IOrderedQueryable<TEntity> SortByDescending<TEntity>(this IQueryable<TEntity> query, Expression<Func<TEntity, dynamic>> sortPredicate)
            where TEntity : class, new()
        {
            return InvokeSortBy(query, sortPredicate, QuerySortOrder.Descending);
        }

        private static IOrderedQueryable<TEntity> InvokeSortBy<TEntity>(IQueryable<TEntity> query,
            Expression<Func<TEntity, dynamic>> sortPredicate, QuerySortOrder sortOrder)
            where TEntity : class, new()
        {
        ...
        private static string GetSortingMethodName(QuerySortOrder sortOrder)
        {
            switch (sortOrder)
            {
