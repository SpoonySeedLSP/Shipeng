...
namespace Shipeng.Util
{
    public class GlobalContext
    {
        ...
        public static void SetCacheControl(StaticFileResponseContext context)
        {
            ...
            context.Context.Response.Headers["Cache-Control"] = "public,max-age=" + second;
            context.Context.Response.Headers["Expires"] = DateTime.UtcNow.AddYears(1).ToString("R"); // Format RFC1123
        }
    }
}
