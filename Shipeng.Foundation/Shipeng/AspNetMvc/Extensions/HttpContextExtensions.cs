...
namespace Microsoft.AspNetCore.Http
{
    ...
    public static class HttpContextExtensions
    {
        ...
        public static void SigninToSwagger(this HttpContext httpContext, string accessToken)
        {
            ...
            // Swagger �?ApiKey 授权不会自动�?Bearer，这里直接返回完�?Authorization �?
            var bearerToken = accessToken.StartsWith("Bearer ")
                ? accessToken
                : "Bearer " + accessToken;

            httpContext.Response.Headers["access-token"] = bearerToken;
            httpContext.Response.Headers["Authorization"] = bearerToken;
        }
