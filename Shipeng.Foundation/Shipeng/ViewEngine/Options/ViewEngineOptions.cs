...
namespace Shipeng.ViewEngine
{
    ...
    public class ViewEngineOptions
    {
        ...
        /// 模板命名空间
        /// </summary>
        public string TemplateNamespace { get; set; } = "Shipeng.ViewEngine";

        /// <summary>
        /// 继承
        /// </summary>
        public string Inherits { get; set; } = "Shipeng.ViewEngine.Template.Models";
