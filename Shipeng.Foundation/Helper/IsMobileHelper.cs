...
namespace Shipeng.Util.Helper
{
    ...
    /// 判断是否是移动, 选择相应的模板
    /// </summary>
    public static class IsMobileHelper
    {
        ...
        /// </summary>
        /// <returns> </returns>
        public static bool IsAdaption()
        {
            bool Bro = GlobalData.Views switch
            {
                "WWW" => false,
                "M" => false,
                "MIP" => false,
        ...
        /// <returns> </returns>
        public static string IsMobileValues(this HttpRequest request)
        {
            string Views = GlobalData.Views;
            switch (Views)
            {
                case "WWW":
                    Views = "Views";//pc视图
