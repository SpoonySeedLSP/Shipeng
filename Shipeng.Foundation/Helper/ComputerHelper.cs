        ...
        public static string GetRunTime()
        {
            ...
            try
            {
                if (IsUnix())
                {
                    ...
                    output = output.Trim();
                    runTime = Extention.FormatTime((DateTime.Now - output.ToDate()).TotalMilliseconds.ToString().Split('.')[0].ToLong());
                }
                else
                {
                    ...
                    {
                        runTime = Extention.FormatTime((DateTime.Now - outputArr[1].Split('.')[0].ToDate()).TotalMilliseconds.ToString().Split('.')[0].ToLong());
                    }
                }
            }
            catch (Exception ex)
