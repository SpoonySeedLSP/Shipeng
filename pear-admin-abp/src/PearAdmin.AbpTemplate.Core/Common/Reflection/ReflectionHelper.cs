...
namespace PearAdmin.AbpTemplate.Common.Reflection
{
    /// <summary>
    /// 反射辅助类
    /// </summary>
    ...
    {
        /// <summary>
        /// 检查是否<paramref name="givenType"/>实现/继承<paramref name="genericType"/>
        /// </summary>
        ...
        /// <param name="propertyPath">属性的完整路径</param>
        /// <returns></returns>
