...
namespace PearAdmin.AbpTemplate.EntityFrameworkCore.EntityTypeConfigurations
{
    ...
    /// 文件明细信息实体模型映射
    /// </summary>
    public class FileListsTypeConfiguration : IEntityTypeConfiguration<FileListsEntity>
    {
        public void Configure(EntityTypeBuilder<FileListsEntity> builder)
        {
            builder.ToTable($"{AbpTemplateCoreConsts.DbTablePrefix}_FileLists");
            ...
            builder.Property(a => a.Bytes)
                .HasMaxLength(FileListsEntity.MaxBytesLength)
                .IsRequired(false);
