...
layui.define(['form', 'jquery', "layer","bodyTab"], function (exports) {
    ...
    $(".functionSetting").click(function(){
        layer.open({
            ...
            success : function(index, layero){
                ...
                $(".functionSrtting_box input[name=changeRefresh]").prop("checked",bodyTab.getChangeRefreshStr()=="true" ? true : false);
    ...
    var obj = {
        getCacheStr: function () {
            return cacheStr;
        }
    }

    exports('admin_cache', obj);
})