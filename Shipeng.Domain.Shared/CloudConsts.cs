namespace Shipeng.Domain.Shared
{
    ...
    public class CloudConsts
    {
        ...
        public static class CachePrefix
        {
            ...
            public const string Cloud_Post = Cloud + ":Post";

            public const string Cloud_Tag = Cloud + ":Tag";

            public const string Cloud_Category = Cloud + ":Category";

            public const string Cloud_FriendLink = Cloud + ":FriendLink";
        }
