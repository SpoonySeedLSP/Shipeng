    ...
    public class WxPayData
    {
        ...
        */
        ...
        public SortedDictionary<string, object> FromXml(string xml)
        {
            ...
            try
            {
                ...
                {
                    LogHelper.WriteLog_WeChartTxtB("微信回调返回4:" + m_values.ToJson());
                    return m_values;
                }
            ...
            //LogHelper.WriteLog_WeChartTxtB("微信回调返回3:" + m_values.ToJson());
            return m_values;
        }
        ...
        */
        ...
        public string MakeSign()
        {
            ...
            string str = ToUrl();
            //在string后加入API KEY
            str += "&key=bb625bbab068c72c7a3e681029b38dc5"; //商户key
            //MD5加密
            MD5 md5 = MD5.Create();
