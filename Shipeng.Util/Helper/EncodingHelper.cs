...
namespace Shipeng.Util
{
    ...
    public static class EncodingHelper
    {
        ...
        private static readonly int[][] GBFreq = new int[94][];
        private static readonly int[][] GBKFreq = new int[126][];
        private static readonly int[][] Big5Freq = new int[94][];
        private static readonly int[][] EUC_TWFreq = new int[94][];

        private static readonly string[] nicename = new string[]{
        ...
        private static int ENCTWProbability(sbyte[] rawtext)
        {
            ...
            // Check to see if characters fit into acceptable ranges and have expected frequency of use
        ...
        private static int UTF8Probability(sbyte[] rawtext)
        {
            ...
            // If not above 98, reduce to zero to prevent coincidental matches Allows for some (few)
            // bad formed sequences
            if (score > 98)
            {
                return score;
            }
        ...
        public static string GetEncodingString(FileInfo file)
        {
            ...
            try
            {
                using (FileStream chinesefile = new FileStream(file.FullName, FileMode.Open, FileAccess.Read))
                {
