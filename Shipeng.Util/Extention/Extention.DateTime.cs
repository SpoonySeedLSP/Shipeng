...
namespace Shipeng.Util
{
    public static partial class Extention
    {
        ...
        public static DateTime ToCstTime(this DateTime dt)
        {
            ...
            DateTimeZone shanghaiZone = DateTimeZoneProviders.Tzdb["Asia/Shanghai"];
        ...
        {
            return new DateTimeOffset(dt).UtcDateTime.Ticks / 10_000_000L - 62135596800L;
        }
        ...
        {
            return new DateTimeOffset(dt).UtcDateTime.Ticks / 10000L - 62135596800000L;
        }
        ...
        {
            return (new DateTimeOffset(dt).UtcTicks - 621355968000000000) / 10;
        }
        ...
        /// <param name="dtEnd">终止时间</param>
        /// <returns>小时差</returns>
        public static TimeSpan GetTimeTimeSpan(this in DateTime dtStar, DateTime dtEnd)
        {
            TimeSpan ts = dtStar - dtEnd;
            return ts;
        }
