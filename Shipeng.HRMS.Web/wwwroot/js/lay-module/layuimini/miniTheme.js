        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://gitee.com/qian_wei_hong/Shipeng.HRMS.wikis/pages" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 开发文档</a>\n' +
                    '<a class="more-menu-item" href="https://gitee.com/qian_wei_hong/Shipeng.HRMS. target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 开源地址</a>\n' +
                    '<a class="more-menu-item" href="http://www.Shipeng.HRMS.vip/" target="_blank"><i class="layui-icon layui-icon-theme"></i> 演示地址</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
            ...
            $('body').on('click', '[data-select-bgcolor]', function () {
                ...
                localStorage.setItem('Shipeng.HRMS.gcolorId', bgcolorId);
                miniTheme.render({
